...
>
> 💡 다양한 프롬프트를 시도해보고 GitHub Copilot의 제안 정확도가 어떻게 달라지는지 확인해보세요. 예를 들어, 인라인 채팅을 사용할 때 추가 프롬프트를 활용해 전체 프롬프트를 다시 작성하지 않고도 응답을 세분화할 수 있습니다.
...
> [!NOTE]
> 왜 올바른 설명이 제공되지 않을 수 있을까요? 비즈니스 로직에 따라 LLM이 명확히 알기 어려운 컴포넌트가 있을 수 있습니다.

### 4. 프로젝트 설치하기

가상 환경을 만들고 프로젝트를 설치하세요. `python setup.py develop`을 실행해 오류를 확인하세요.

- GitHub Copilot Chat에 오류를 붙여넣고 원인과 해결 방법을 안내받으세요.
